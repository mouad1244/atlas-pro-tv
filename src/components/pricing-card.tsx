  ...
  return (
    <div
      className={`group relative flex h-full flex-col rounded-[2rem] p-7 text-white transition-all duration-300 ease-out sm:p-8 ${
        plan.featured
          ? "border border-primary/45 bg-gradient-to-b from-surface to-ink-soft shadow-[0_25px_60px_-20px_rgba(47,111,237,0.55)] hover:-translate-y-2 hover:shadow-[0_34px_74px_-16px_rgba(47,111,237,0.65)] lg:-translate-y-4 lg:hover:-translate-y-6"
          : "card-glass backdrop-blur-xl hover:-translate-y-2 hover:border-primary/35 hover:bg-white/[0.06] hover:shadow-[0_28px_56px_-20px_rgba(47,111,237,0.35)]"
      }`}
    >
      {plan.badge && (
        <span className="animate-badge-pulse absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-primary-light via-violet to-cyan px-4 py-1.5 text-[12px] font-bold text-white shadow-lg">
          {plan.badge}
        </span>
      )}

      <div>
        <span className="inline-flex items-center rounded-full border border-white/10 bg-white/8 px-3 py-1 text-[12.5px] font-semibold text-primary-light">
      ...
      <a
        ...
        className="mt-7 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-primary-light via-primary to-primary-dark px-6 py-3.5 text-[13.5px] font-bold uppercase tracking-wide text-white shadow-[0_14px_30px_-10px_rgba(47,111,237,0.65)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_38px_-8px_rgba(47,111,237,0.8)] active:scale-[0.98] active:translate-y-0"
      >
        Profitez de l&apos;offre
      </a>
