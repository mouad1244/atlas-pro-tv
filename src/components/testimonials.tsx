...
export function Testimonials() {
  return (
    <section id="testimonials" className="relative overflow-hidden bg-ink-soft py-20 md:py-28">
      ...
      <div className="group relative mt-14">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-gradient-to-r from-ink-soft to-transparent sm:w-28" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-gradient-to-l from-ink-soft to-transparent sm:w-28" />
        ...
        >
          {LOOP.map((t, i) => (
            <div
              key={`${t.name}-${i}`}
              className="card-glass relative flex h-[302px] w-[300px] shrink-0 flex-col overflow-hidden rounded-2xl backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-primary/30 hover:shadow-[0_20px_44px_-18px_rgba(47,111,237,0.35)] sm:w-[340px]"
            >
              {/* Avatar banner */}
              ...
              <span className="absolute left-6 top-[3.25rem] flex h-14 w-14 items-center justify-center rounded-full border-4 border-ink-soft bg-gradient-to-br from-primary-light to-primary text-[15px] font-semibold text-white shadow-md">
                {t.name
                  .split(" ")
                  .map((n) => n[0])
                  .join("")}
              ...
              <div className="flex flex-1 flex-col px-6 pb-6 pt-9">
                ...
                <p className="mt-3 line-clamp-4 flex-1 text-[14px] leading-relaxed text-white/65">
                  &ldquo;{t.text}&rdquo;
                </p>
              </div>
            </div>
      ...
      <div className="container-page">
        <div className="card-glass mx-auto mt-12 flex max-w-md items-center justify-center gap-4 rounded-2xl px-6 py-4 text-center backdrop-blur-xl sm:gap-6">
